...
var DragThree = new Shape("Line", 10, 300, 180, 90, colArray[0][0], colArray[6][2], colArray[0][2], colArray[6][0], canvas);
buttonSet.push(DragThree);
var DragFour = new Shape("Drawing", 10, 400, 180, 90, colArray[0][0], colArray[6][2], colArray[0][2], colArray[6][0], canvas);
